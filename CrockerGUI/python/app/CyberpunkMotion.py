...
class CyberpunkMotionController(QObject):
    ...
    def _prepare_button(self, button: QPushButton) -> None:
        if button.property("cyberpunkMotion"):
            return
        button.setProperty("cyberpunkMotion", True)
    ...
    def _set_button_state(self, button: QPushButton, *, hover: bool, pressed: bool) -> None:
        button.setProperty("cyberpunkHover", hover)
        button.setProperty("cyberpunkPressed", pressed)
