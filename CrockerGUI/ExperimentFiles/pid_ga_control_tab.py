...
from PyQt6.QtGui import QColor, QBrush, QFont, QPainter, QPen, QPolygonF
...
from pid_axis_trend_plot import AxisTrendPlot as TrendPlot
...
class PIDGAControlTab(QWidget):
    ...
    def _ga_restore_tick(self, now: float) -> None:
        ...
        restore_beam = float(beam_snapshot.get("value_nA", float("nan")))
